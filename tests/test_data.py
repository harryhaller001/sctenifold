...
def test_featch_morphine_datasets():
    """Testing fetch of morphine dataset."""
    _ = fetch_data("morphine")


def test_featch_AD_datasets():
    """Testing fetch of AD dataset."""
    _ = fetch_data("AD")


def test_featch_Nkx2_KO_datasets():
    """Testing fetch of Nkx2 KO dataset."""
    _ = fetch_data("Nkx2_KO")


def test_featch_aging_datasets():
    """Testing fetch of aging dataset."""
    _ = fetch_data("aging")


def test_featch_dsRNA_datasets():
    """Testing fetch of dsRNA dataset."""
    _ = fetch_data("dsRNA")
